    ...
    <section className="relative w-full aspect-video overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-end pl-6 pr-6 md:pr-16 lg:pr-24">
        <div className="max-w-xs sm:max-w-md md:max-w-lg lg:max-w-2xl">
          ...
          <a
            href="/about"
            className="inline-block border border-violet-300/30 px-3 py-1 sm:px-6 sm:py-2.5 uppercase text-[9px] sm:text-xs md:text-sm hover:bg-violet-500/20 transition-all rounded-sm text-white"
          >
            READ MORE ABOUT US
          </a>
        </div>
