    ...
    <section id="contact" className="relative min-h-[80vh] flex items-center pt-20 pb-36 px-4">
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          <ScrollReveal variant="fadeInLeft" duration={800} threshold={0.15}>
            <div>
          ...
          <ScrollReveal variant="fadeInRight" duration={800} threshold={0.15}>
            <div className="flex flex-col justify-center space-y-8 lg:pl-8 h-full">
