  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 text-center w-full px-4">
        <h1 className="text-2xl md:text-6xl lg:text-6xl uppercase font-bold text-white tracking-[0.05em] sm:tracking-[0.15em] [text-shadow:0_2px_20px_rgba(0,0,0,0.5)] leading-tight">
      ...
      >
        <div className="bg-white/10 backdrop-blur-md rounded-lg p-4 px-6 border border-white/10 flex items-center gap-6 hover:bg-white/15 transition-colors">
