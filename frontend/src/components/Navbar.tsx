    ...
    <>
      ...
      >
        <div className="relative flex w-full items-center justify-between">
          ...
          <div className={`md:hidden absolute top-12 right-0 flex flex-col gap-4.5 items-center w-6 z-40 transition-all duration-300 ${isAtTop ? "opacity-100 scale-100 pointer-events-auto" : "opacity-0 scale-90 pointer-events-none"}`}>
            <a
            ...
            >
              <svg
                className="w-4 h-4 text-white/70 hover:text-pink-500 transition-colors"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            >
              <svg
                className="w-4 h-4 text-white/70 hover:text-blue-400 transition-colors"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            >
              <svg
                className="w-4 h-4 text-white/70 hover:text-red-500 transition-colors"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
